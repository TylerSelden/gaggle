...
function load() {
  ...
  elems.username.value = readQueryVariable("id") ? atob(readQueryVariable("id")) : data.username;
  elems.password.value = readQueryVariable("password") ? atob(readQueryVariable("password")) : data.password;
