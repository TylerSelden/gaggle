var tier = [
    ...
    create_session: function() {
      api.create_session(credentials.username, credentials.password, elems.tier_2_username.value, elems.tier_2_password.value, elems.tier_2_select.value, elems.tier_2_select.classList.contains("dev"), (res) => {
				if (res.code !== 0) return alert(res.data);
				console.log(elems.tier_2_select.value);
				get_sessions();
